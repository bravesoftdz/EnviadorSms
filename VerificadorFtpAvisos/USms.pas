...
procedure TFVerificador.TverificandoTimer(Sender: TObject);
  ...
  begin
    ...
    if FileExists(Empresa+'\AvisoInatividadeSms.txt') then begin
      ConectaFtpAviso(Empresa);
      Try
        IdFTPAviso.Put(Empresa+'\'+'AvisoInatividadeSms.txt','AvisoInatividadeSms.txt',False);
      Finally
    ...
    if FileExists(Empresa+'\AvisoInatividadeEmail.txt') then begin
      ConectaFtpAviso(Empresa);
      Try
        IdFTPAviso.Put(Empresa+'\AvisoInatividadeEmail.txt','AvisoInatividadeEmail.txt',False);
      finally
    ...
    if FileExists(Empresa+'\TextoAvisoInatividade.txt') then begin
      ConectaFtpAviso(Empresa);
      try
        IdFTPAviso.Put(Empresa+'\TextoAvisoInatividade.txt','TextoAvisoInatividade.txt',False);
      finally
